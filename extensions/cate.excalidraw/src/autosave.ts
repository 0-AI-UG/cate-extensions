// =============================================================================
// Debounced autosave with an explicit flush. Serialization is deferred to save
// time (only the latest snapshot is ever serialized), and flush() lets the
// panel persist the last edits immediately on hide/close instead of losing
